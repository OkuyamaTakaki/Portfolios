(() => {
    ...
    const translations = Object.freeze({
        ja: Object.freeze({
            ...
            "shift.alt": "色付きのブロックとボールを表示したブロック崩しゲーム画面",
            ...
            "haita.title": "ハイターチャレンジ",
            "haita.description": "職員に見つからないよう液体を注ぎ、メーターを満タンにするステルスゲームです。",
            "haita.playLabel": "ハイターチャレンジをプレイ",
            "grass.title": "30秒 草収穫ゲーム",
            "grass.description": "草を集め、とげを避けて高得点を狙うゲーム。3段階の難易度を選べます。",
            "grass.playLabel": "30秒 草収穫ゲームをプレイ",
            "skills.eyebrow": "技術",
            "skills.title": "使用技術",
        ...
        en: Object.freeze({
            ...
            "shift.alt": "Block-breaking game screen with colored blocks, a ball, and a paddle",
            ...
            "haita.title": "Haita Challenge",
            "haita.description": "A stealth game where you pour liquid and fill the meter without being spotted by staff.",
            "haita.playLabel": "Play Haita Challenge",
            "grass.title": "30-Second Grass Harvest",
            "grass.description": "Collect grass, avoid spikes, and aim for a high score across three difficulty levels.",
            "grass.playLabel": "Play 30-Second Grass Harvest",
